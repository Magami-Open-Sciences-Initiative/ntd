...
export const dracunculiasisSpike: Spike = {
  ...
  stats: [
    ...
    },
    {
      ...
      year: 2024,
      geography: "global",
      note: "confirmed final (provisional was 14 in Jan 2025); 9 in Chad, 6 in South Sudan; 2023: 14, 2022: 13",
      source: { label: "WHO — dracunculiasis eradication: global surveillance summary, 2024 (WER 100(20-21):165–191)", url: "https://www.who.int/publications/i/item/who-wer10020-21-165-191" },
    },
    {
      label: "Cases by country, 2025",
      value: "Chad 4, Ethiopia 4, South Sudan 2",
      note: "10 human cases across three countries; provisional until the April 2026 confirmation meeting",
      source: { label: "The Carter Center — 10 human cases reported in 2025 (Jan 2026)", url: "https://www.cartercenter.org/news/guinea-worm-announcement" },
    },
    {
      ...
      year: 2024,
      geography: "Africa",
      note: "confirmed final (provisional was 661); Cameroon 310 and Chad 281 (234 dogs, 47 cats) account for 89%; remainder in Angola, Mali, Ethiopia (2 baboons) and South Sudan",
      source: { label: "CDC — Progress toward eradication, Jan 2024–Jun 2025 (MMWR 74(42))", url: "https://www.cdc.gov/mmwr/volumes/74/wr/mm7442a2.htm" },
    },
    {
      label: "Animal infections, 2025",
      value: "683",
      number: 683,
      unit: "animals",
      year: 2025,
      geography: "Africa",
      note: "provisional; Cameroon 445, Chad 147, Angola 70, Mali 17, Ethiopia 1, South Sudan 3",
      source: { label: "The Carter Center — 10 human cases reported in 2025 (Jan 2026)", url: "https://www.cartercenter.org/news/guinea-worm-announcement" },
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      body:
        "The worm infects dogs, cats and baboons as well as people, and it is the same species, Dracunculus medinensis. Eradication therefore requires stopping infection in animals too, and animal infections now outnumber human cases by a factor of dozens — 664 confirmed in 2024 and a provisional 683 in 2025. The geography has shifted: Chad, once the epicentre, fell for a sixth consecutive year to 147 animal infections in 2025, while Cameroon — where indigenous transmission re-established after cross-border importation from Chad — rose to 445 and is now the largest share.\n\nChad added a further complication. There, infections have been linked to fish and frogs that act as paratenic hosts: the larvae survive inside them without developing, so a person or dog that eats the fish or frog can become infected. That breaks the old model in which the only route was drinking water containing infected copepods, and it means interventions designed around water alone may not be sufficient. Understanding and interrupting this route is the central scientific problem standing between the programme and zero.",
  ...
  institutions: ["carter-center", "who", "cdc", "gates-foundation", "ntd-support-center", "university-of-georgia"],
