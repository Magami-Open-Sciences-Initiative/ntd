...
export const EMERGING_SPIKES: Record<string, Spike> = {
  malaria: {
    sections: [
      ...
      },
      {
        ...
        body:
          "For decades a malaria vaccine was considered impractical — the parasite has more than five thousand genes and a life cycle that presents different antigens at every stage. RTS,S/AS01 took thirty years to develop and protects partially: roughly a third to a half reduction in clinical malaria in young children. WHO recommended it in 2021 after a pilot in Ghana, Kenya and Malawi showed it could be delivered through routine immunisation without harming uptake of other vaccines.\n\nR21/Matrix-M, recommended in 2023, offers comparable protection with far greater manufacturing capacity and lower cost, which is what makes wide rollout realistic — 25 African countries now offer malaria vaccines, targeting over 10 million children a year. In May 2026 a Lancet evaluation confirmed the payoff: RTS,S cut all-cause child mortality 13% (one in eight deaths averted) with severe admissions down 22%, despite only 71% three-dose and 40% four-dose uptake. Neither vaccine eliminates malaria, and both require a booster. What they change is the arithmetic: a partially effective vaccine added to nets, spraying and treatment reduces deaths across a whole birth cohort, and it is the first genuinely new tool the field has had in two decades.",
        refs: ["malaria-vaccines", "rts-s-malaria-pilot", "r21-matrix-m", "mvip-mortality-evaluation"],
      },
      {
        id: "new-drugs",
        title: "The first new treatment since 1999",
        body:
          "In November 2025 the KALUMA Phase 3 (1,688 patients, 34 sites, 12 African countries) showed ganaplacide-lumefantrine (GanLum) non-inferior to Coartem at 97.4% PCR-corrected efficacy — the first novel-acting malaria treatment since 1999, with a new secretory-pathway mechanism that kills resistant parasites and blocks transmission, dosed once daily for three days as granules. Behind it: cipargamin (PfATP4, very-fast killer, in Phase 2 with GanLum), a first-trimester-pregnancy Phase 3, and Swissmedic-approved Coartem Baby for infants under 5 kg (launched Ghana, registered Malawi). After decades of defending artemisinins, the field finally has somewhere to go.",
        refs: ["ganaplacide", "cipargamin", "pfatp4", "kaluma-ganlum-ph3", "cipargamin-ganlum-ph2"],
      },
      {
        id: "chemoprevention",
  ...
  tuberculosis: {
    sections: [
      ...
      },
      {
        ...
        body:
          "Multidrug-resistant tuberculosis is a man-made epidemic. It is generated when treatment is interrupted, drugs run out, or regimens are inadequate, which means it is produced by weak health systems rather than by biology alone. Around 400,000 people develop it each year, and the great majority are never tested for resistance, so they receive drugs that will not cure them and continue to transmit resistant infection — in 2024 only about two in five people with drug-resistant TB accessed treatment at all.\n\nUntil recently, treating it meant up to two years of therapy including injectable drugs with severe toxicity. The BPaLM regimen — bedaquiline, pretomanid, linezolid and moxifloxacin, all oral, six months — changed that, and PRACTECAL produced the evidence. Uptake is accelerating sharply: about 34,000 people started the shorter all-oral regimens in 2024, up from 5,653 in 2023 and 1,744 in 2022. It is one of the fastest translations of a trial into global policy in tuberculosis, and it came from a non-profit developer and a humanitarian organisation working where the market had no interest.",
  ...
  ebola: {
    sections: [
      ...
      {
        id: "species-gap",
        title: "The species gap: everything licensed covers only Zaire",
        body:
          "All licensed Ebola countermeasures — Ervebo, Zabdeno/Mvabea, ansuvimab and Inmazeb — work against one virus, Zaire ebolavirus. Sudan virus has caused eight outbreaks with case fatality of 41–70%, including 164 cases and 77 deaths in Uganda in 2022–23, with nothing licensed to offer. Bundibugyo virus had caused only two small outbreaks before 2026 — and then became the emergency. The 2025 Uganda Sudan outbreak hosted the first-ever Sudan efficacy trial, Tokomeza, launched within four days of declaration by Makerere University and the Uganda Virus Research Institute; it ended with the outbreak at 14 cases, too few to estimate efficacy but enough to prove an African-led ring trial can start inside the response window. Closing the species gap — Sudan and Bundibugyo vaccines and antibodies — is now the single most consequential R&D task in filoviruses, and the 2026 outbreak is the trial platform it will be tested on.",
        refs: ["tomokeza-sudan-ebola", "ebola-vaccines", "ansuvimab", "inmazeb", "cepi"],
      },
      {
        id: "bundibugyo-2026",
        title: "2026: Bundibugyo becomes the largest filovirus outbreak on record",
        body:
          "In May 2026 a Bundibugyo virus outbreak was detected in the eastern Democratic Republic of the Congo and spread to Uganda; on 16 May it was declared a Public Health Emergency of International Concern. By early September it had reached 6,778 confirmed cases with a fatality ratio around 44–48%, surpassing the West African epidemic's confirmed count pace and including exported cases in responders treated in France and Germany, infections in displacement camps, and more than 300 child deaths. There is no licensed vaccine or treatment for Bundibugyo virus disease, so control rests on case finding, isolation, contact tracing, safe burials and community engagement. Two things changed the outlook: WHO's vaccine advisory group found preliminary animal data suggesting Ervebo may partially cross-protect — especially against death — and recommended it for a randomised Phase 3 ring trial, launched in August 2026; and a first Bundibugyo case treated with monoclonal antibodies plus remdesivir was reported, the first clinical signal for a Sudan/Bundibugyo therapeutic. CEPI is funding a fifth Bundibugyo vaccine candidate, and the EU, Gavi and EDCTP have committed tens of millions to the response and R&D.",
        refs: ["ervebo-bundibugyo-ring-trial", "ebola-vaccines", "ring-vaccination", "cepi", "gavi", "outbreak-response"],
      },
      {
        id: "spillover",
  ...
  zika: {
    sections: [
      ...
      },
      {
        ...
        body:
          "The 2016 emergency mobilised research unusually fast: vaccine candidates entered clinical trials within a year, diagnostic tests were developed and distributed, and birth-defect surveillance was strengthened across the Americas. It also exposed how little was known about a virus that had been described seven decades earlier — its sexual transmission, its persistence in body fluids, and the full range of its congenital effects were all established during the emergency itself.\n\nWhen the emergency ended in November 2016, attention moved on, and that is the pattern that matters. Vaccine development stalled without a market or a sustained epidemic to justify late-stage trials — the field's largest efficacy trial, VRC 705 in 2,428 participants, completed without producing a licensed vaccine because cases collapsed before it could measure protection; surveillance weakened; and the virus remains in circulation with no licensed vaccine, no antiviral, and a diagnostic that only works in a narrow window. Local mosquito transmission reached Europe for the first time in 2019. In 2022 WHO folded Zika into a Global Arbovirus Initiative with dengue and chikungunya, an admission that these viruses have to be fought as a group rather than one emergency at a time. A Public Health Emergency of International Concern is a powerful instrument for raising alarm and a poor one for finishing anything.",
