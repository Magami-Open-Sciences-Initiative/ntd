  ...
  stats: [
    {
      ...
      year: 2018,
      geography: "global",
      note: "a 74% decline since the Global Programme to Eliminate LF began in 2000",
    ...
    },
    {
      ...
      year: 2023,
      geography: "global",
      note: "in 39 countries that still require preventive chemotherapy",
      source: { label: "WHO — lymphatic filariasis (fact sheet)", url: "https://www.who.int/news-room/fact-sheets/detail/lymphatic-filariasis" },
    },
    {
      ...
      year: 2023,
      geography: "global",
      note: "still requiring preventive chemotherapy; 81 were considered endemic at the programme's start",
      source: { label: "WHO — lymphatic filariasis (fact sheet)", url: "https://www.who.int/news-room/fact-sheets/detail/lymphatic-filariasis" },
    },
    {
    ...
    },
    {
      ...
      value: "9.7 billion",
      number: 9.7,
      unit: "billion treatments",
      year: 2023,
      geography: "global",
      note: "to more than 943 million people at least once, in 71 countries",
      source: { label: "WHO — lymphatic filariasis (fact sheet)", url: "https://www.who.int/news-room/fact-sheets/detail/lymphatic-filariasis" },
    },
    {
      label: "No longer requiring preventive chemotherapy",
      value: "871 million",
      number: 871,
      unit: "million people",
