...
export const leprosySpike: Spike = {
  ...
  stats: [
    { label: "New cases (2024)", value: "172,717", note: "−5.5% from 2023" },
    { label: "New cases (2023)", value: "182,815", note: "−14% from 2022" },
    { label: "Countries reporting cases", value: "> 120" },
    { label: "Countries above 10,000 cases", value: "3", note: "India, Brazil and Indonesia" },
    { label: "Children among new cases", value: "5.7%", note: "266 with grade-2 disability at diagnosis" },
    { label: "Post-exposure prophylaxis", value: "~57–60%", note: "risk reduction from single-dose rifampicin" },
  ],
