...
export const trachomaSpike: Spike = {
  ...
  stats: [
    ...
    { label: "Countries validated", value: "27", note: "with at least one in every endemic WHO region" },
    { label: "Azithromycin donated", value: "> 1.1 billion doses", note: "by Pfizer through the ITI, extended to 2030" },
