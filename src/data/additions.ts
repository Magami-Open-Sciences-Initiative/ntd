    ...
    records: [
      {
        ...
        registryUrl: "https://clinicaltrials.gov/study/NCT05180461",
      ...
      },
      {
        ...
        registryUrl: "https://trialsearch.who.int/Trial2.aspx?TrialID=PACTR202412611774752",
      ...
      },
      {
        ...
        registryUrl: "https://clinicaltrials.gov/study/NCT05999825",
        status: "Active",
      ...
      },
      {
        ...
        registryUrl: "https://clinicaltrials.gov/study/NCT02956746",
...

  {
    ...
    records: [
      ...
      },
      {
        ...
        tldr: "A dengue antiviral with published NEJM challenge-trial protection, orphaned by J&J's exit — awaiting a new sponsor.",
        summary:
          "Mosnodenvir is a small-molecule antiviral blocking the dengue NS3–NS4B interaction (EC50 0.057–11 nM across serotypes) with, unusually for the field, demonstrated protection in a controlled human infection model: 6 of 10 high-dose recipients uninfected, the rest low-viraemia (NEJM). It was safe and well tolerated in Phase 1 and 2a. In October 2024 J&J halted the ~1,600-participant Phase 2 field study on exiting infectious diseases entirely — a commercial decision, not a safety signal — and the compound sits in limbo with adoption talks under way. The result is that dengue still has no approved antiviral, but for the first time the field holds published human efficacy data and a rescue conversation rather than just a discontinued programme.",
        ...REVIEW,
        drugClass: "Small-molecule antiviral (NS3–NS4B interaction inhibitor)",
        mechanism: "Blocks the interaction between dengue NS3 and NS4B in the replication complex, halting viral RNA synthesis across all four serotypes.",
        indication: "Prevention (and potentially early treatment) of dengue (investigational; development halted).",
        administration: "Oral, daily.",
        status: "Phase 2 halted Oct 2024 (sponsor exit); NEJM challenge data published; new sponsor sought",
        links: [
          { label: "Daily mosnodenvir as dengue prophylaxis (NEJM)", url: "https://www.nejm.org/do/10.1056/NEJMdo008250/full" },
        ...
        terms: ["tpp"],
        stats: [
          { label: "Challenge result", value: "6/10 high-dose uninfected", note: "remainder low-viraemia; NEJM" },
          { label: "Field enrolment", value: "~1,600", number: 1600, unit: "participants", note: "halted on sponsor exit, not on data" },
        ],
      },
      {
        id: "ixchiq",
        name: "Ixchiq (chikungunya vaccine)",
        tldr: "The first licensed chikungunya vaccine, whose US licence was suspended in 2025 and withdrawn in 2026 after chikungunya-like serious events — while Brazil rolls it out.",
        summary:
          "Ixchiq is a live-attenuated chikungunya vaccine and the first product of any kind licensed against the disease, given as a single dose. In May 2025 the FDA and CDC paused its use in people aged 60 and older after post-marketing reports of serious neurological and cardiac events — seventeen in total, including two deaths, in recipients aged 62 to 89. In August 2025 the FDA suspended the US biologics licence over chikungunya-like illness in recipients, including hospitalisations and encephalitis with one death, and in January 2026 Valneva voluntarily withdrew the US application. Europe lifted its own elderly restriction, and the product's centre of gravity moved to endemic countries: Brazil licensed it in April 2025, approved locally made VLA1555 in May 2026, and launched a pilot Ixchiq campaign in February 2026 with about 45,000 vaccinated. Four-year follow-up shows 95% seroresponse after a single shot.",
        ...REVIEW,
        ...
        status: "US licence withdrawn (Jan 2026); approved EU (12+), UK, Canada, Brazil; Brazil pilot rollout 2026",
        links: [
          { label: "FDA — Ixchiq licence suspension (Aug 2025)", url: "https://www.fda.gov/safety/medical-product-safety-information/fda-update-safety-ixchiq-chikungunya-vaccine-live-fda-suspends-biologics-license-fda-safety" },
          { label: "Valneva — US withdrawal (Jan 2026)", url: "https://valneva.com/press-release/valneva-provides-update-on-chikungunya-vaccine-ixchiq/" },
        ],
        ...
        stats: [
          ...
          { label: "US outcome", value: "Licence suspended Aug 2025, withdrawn Jan 2026" },
          { label: "Durability", value: "95% seroresponse at 4 years", note: "single shot", source: { label: "Valneva — company presentation (July 2026)", url: "https://valneva.com/wp-content/uploads/2026/07/Valneva_Company_Presentation-July-2026.pdf" } },
          { label: "Brazil pilot", value: "≈ 45,000 vaccinated", note: "from February 2026", source: { label: "Valneva — company presentation (July 2026)", url: "https://valneva.com/wp-content/uploads/2026/07/Valneva_Company_Presentation-July-2026.pdf" } },
        ],
      },
      {
        id: "vimkunya",
        name: "Vimkunya (chikungunya vaccine)",
        tldr: "A virus-like-particle chikungunya vaccine approved in the US, EU, UK and Switzerland by 2026 — the product the field now leans on.",
        summary:
          "Vimkunya is a virus-like-particle vaccine against chikungunya, given as a single adjuvanted dose. Because it carries no viral genetic material it cannot cause disease, so it was never caught by the safety action that ended Ixchiq in the United States. By April 2026 it held approvals in the US (Feb 2025), EU, UK (May 2025) and Switzerland (Apr 2026, ages 12+), with Brazil (Eurofarma, Anvisa filing July 2026) and Canada pending. Published data show cross-neutralisation across CHIKV lineages after a single dose, a dedicated over-65 Phase 3, and a paediatric Phase 3 (ages 2–11) under way — the age expansion Ixchiq lost.",
        ...REVIEW,
        ...
        indication: "Prevention of chikungunya disease.",
        administration: "Single intramuscular dose.",
        status: "Licensed US/EU/UK (2025), Switzerland (2026); Brazil and Canada filings pending; paediatric Phase 3 under way",
        ...
        links: [
          ...
          { label: "Bavarian Nordic — Swissmedic approval (Apr 2026)", url: "https://www.bavarian-nordic.com/investor/news/news.aspx?news=7492" },
        ],
        diseases: ["chikungunya"],
        pathogens: ["chikungunya-virus"],
        technologies: ["chikungunya-vaccination"],
        trials: ["vimkunya-pediatric", "vimkunya-older-adults", "chikv-vlp-followup"],
        stats: [
          { label: "Dosing", value: "Single dose" },
          { label: "Platform", value: "Virus-like particle (not live-attenuated)" },
          { label: "Approvals by Apr 2026", value: "US, EU, UK, Switzerland", note: "ages 12 and older" },
        ],
      },
    ],
  },
    ...
    records: [
      {
        ...
        registryUrl: "https://clinicaltrials.gov/study/NCT06481163",
      ...
      },
      {
        ...
        registryUrl: "https://clinicaltrials.gov/study/NCT04546724",
      ...
      },
      {
        ...
        registryUrl: "https://clinicaltrials.gov/study/NCT03587766",
...

  {
    ...
    records: [
      ...
      },
      {
        ...
        stats: [
          { label: "Vector transmission verified interrupted", value: "8 countries", note: "full territory in Chile, Paraguay and Uruguay; part of the territory in Argentina, Brazil, Colombia, Peru and Bolivia (WHO 2026). A further 9 countries claimed interruption under the sub-regional initiatives, for the widely quoted historical total of 17 (PAHO)" },
          { label: "Blood donors screened", value: "21 endemic countries", note: "universal screening in all blood banks of continental Latin America" },
        ],
      },
      {
        id: "unitaid",
...

  {
    ...
    records: [
      ...
      },
      {
        ...
        summary:
          "LXE408 is a first-in-class oral compound developed by DNDi with Novartis as a potential new treatment for visceral leishmaniasis. It is a parasite-selective inhibitor of the kinetoplastid proteasome — a mechanism new to leishmaniasis, and one active against L. donovani, L. infantum and the trypanosomes that cause Chagas disease and sleeping sickness. Two Phase II studies ran in parallel, in India and in Ethiopia, comparing LXE408 with local standard of care; recruitment and follow-up completed in 2025 and results are expected in 2026. It is the field's best hope of a short oral regimen, and it belongs to a class new to leishmaniasis, which also makes it useful if resistance to current drugs emerges. A Phase II study in cutaneous leishmaniasis in the Americas began in 2026.",
        ...REVIEW,
        drugClass: "First-in-class oral kinetoplastid proteasome inhibitor",
        mechanism:
          "Selectively inhibits the kinetoplastid proteasome, blocking protein degradation in the parasite; potent and uniform activity across Leishmania and Trypanosoma species tested.",
        indication: "Visceral leishmaniasis (Phase 2); cutaneous leishmaniasis (Phase 2, Americas).",
        administration: "Oral.",
        status: "Two Phase 2 studies (India, Ethiopia) completed follow-up 2025; results expected 2026; cutaneous Phase 2 starting 2026",
        links: [
        ...
        terms: ["pdp"],
        stats: [
          { label: "Mechanism", value: "Kinetoplastid proteasome inhibitor" },
          { label: "Results expected", value: "2026", year: 2026, note: "from the India and Ethiopia Phase 2 studies" },
        ],
      },
      {
        id: "bedaquiline",
    ...
    records: [
      {
        ...
        registryUrl: "https://clinicaltrials.gov/study/NCT03662022",
        status: "Reported positive",
      ...
      },
      {
        ...
        registryUrl: "https://clinicaltrials.gov/study/NCT05406479",
        status: "Active",
    ...
    records: [
      {
        ...
        registryUrl: "https://clinicaltrials.gov/study/NCT03086226",
        ...
        result:
          "Stopped early for futility; 12-month complete cure was 50% (300 mg weekly), 65% (200 mg weekly) and 75% (itraconazole) — neither fosravuconazole dose superior, but no new safety concerns and the convenience of weekly dosing.",
        links: [
          { label: "Trial results (The Lancet Infectious Diseases, 2024)", url: "https://pubmed.ncbi.nlm.nih.gov/39098321/" },
        ],
        diseases: ["mycetoma"],
        drugs: ["fosravuconazole", "itraconazole"],
        institutions: ["mrc-khartoum", "dndi"],
        terms: ["tpp"],
        stats: [
          { label: "Enrolment", value: "104", number: 104, unit: "patients", geography: "Sudan", source: { label: "Fahal et al., Lancet Infect Dis 2024", url: "https://pubmed.ncbi.nlm.nih.gov/39098321/" } },
          { label: "Cure (itraconazole)", value: "75%", note: "12 months, with surgery at 6 months" },
          { label: "Outcome", value: "Terminated early for futility" },
        ],
      },
      {
...

  {
    ...
    records: [
      ...
      },
      {
        ...
        summary:
          "Liverpool School of Tropical Medicine is a long-established centre for tropical disease research, and in 2026 its researchers, with MSF and the University of Liverpool, published the first deep metagenomic study of noma — identifying a novel Treponema species, 'Treponema sp. A', in 15 of 19 Nigerian children with acute noma and showing severe disruption of the oral microbiome, alongside antibiotic-resistance determinants. The finding is significant because noma has no single known cause and no diagnostic test; a microbial marker could allow recognition before the disease becomes gangrenous. LSTM also works on scabies, snakebite and other diseases in the NTD portfolio.",
        ...REVIEW,
        institutionType: "Research institute",
