    ...
    records: [
      {
        ...
        stats: [
          ...
          { label: "Potency vs M. ulcerans", value: "MIC 0.0000075 mg/L", note: "lowest of drugs tested" },
        ],
      },
    ],
  },
    ...
    records: [
      {
        ...
        summary:
          "Telacebec is an imidazopyridine developed for tuberculosis that blocks QcrB in the mycobacterial respiratory chain. Against Mycobacterium ulcerans it has the lowest minimum inhibitory concentration of any drug tested — far below rifampicin or clarithromycin — and in mouse models it sterilised the infection after only sixteen doses, which would translate into an ultrashort regimen. TB Alliance initiated a Phase 2 proof-of-concept trial (TREAT-BU) in mid-2024. It is the clearest example in the NTD field of the repurposing strategy: take a molecule whose safety is already established for one mycobacterial disease and prove it works for another, rather than inventing a new drug for a market that cannot pay.",
        ...REVIEW,
        ...
        status: "Phase 2 (TREAT-BU trial, started 2024)",
        resistance:
        ...
        stats: [
          ...
          { label: "Mouse model", value: "Sterilised after 16 doses" },
        ],
      },
      {
        id: "mosnodenvir",
    ...
    records: [
      {
        ...
        summary:
          "Mycobacterium ulcerans causes disease entirely through mycolactone, its toxin, so detecting the toxin is a direct way to diagnose the infection. Fluorescent thin-layer chromatography has been evaluated at district level, and other assay formats are in development. The value is practical: PCR requires a reference laboratory and a sample transport chain, whereas a toxin test could be done where the patient presents, allowing treatment to start before the lesion extends. A point-of-care test is one of WHO's stated research priorities for Buruli ulcer precisely because late diagnosis is the main driver of disability.",
        ...REVIEW,
        method: "Detection of mycolactone toxin in tissue (for example fluorescent thin-layer chromatography)",
        sampleType: "Swab, fine-needle aspirate or tissue",
        turnaround: "Hours at district level in evaluated formats",
        performance:
          "Distinguishes Buruli ulcer from other chronic ulcers; a true point-of-care test remains a research priority.",
    ...
    records: [
      {
        ...
        tldr: "A Phase 2 trial testing whether a tuberculosis drug can cure Buruli ulcer in far fewer than eight weeks of treatment.",
        summary:
          "TREAT-BU is a Phase 2 proof-of-concept study of telacebec in adults with Buruli ulcer, initiated by TB Alliance in July 2024. The endpoint is complete healing of the lesion by 52 weeks after starting treatment, without relapse. The rationale is unusually strong: telacebec has the lowest minimum inhibitory concentration of any drug tested against Mycobacterium ulcerans and sterilised the infection in mice after only sixteen doses. If it works in people, the eight-week antibiotic course that is now standard could be replaced by a regimen of a few doses — which matters most for the patients who live furthest from a clinic.",
        ...REVIEW,
        phase: "Phase 2",
        status: "Active (initiated 2024)",
        intervention: "Telacebec, oral",
        sponsor: "TB Alliance",
        result: "Ongoing; endpoint is complete lesion healing at 52 weeks without relapse.",
        links: [
          { label: "TREAT-BU trial (ClinicalTrials.gov)", url: "https://clinicaltrials.gov/study/NCT06481163" },
        ],
        diseases: ["buruli-ulcer"],
...

  {
    ...
    records: [
      ...
      },
      {
        ...
        tldr: "An environmental and animal surveillance approach that flags emerging Buruli ulcer hotspots two to six years before human cases appear.",
        summary:
          "Buruli ulcer moves: incidence rises in some places and falls in others, and it appears in areas that were previously free of it. A tool developed by the Doherty Institute in Australia uses environmental sampling — including mosquito and possum surveillance where they are implicated in transmission — to identify emerging hotspots two to six years before human infections occur. The value is that prevention can be targeted before people are affected, rather than surveillance merely confirming an outbreak that has already happened. It is one of the few genuinely predictive tools in the NTD field, and it complements the search for a point-of-care diagnostic.",
        ...REVIEW,
        category: "AI & computation",
        maturity: "Prototype, applied in Australia",
        whatItDoes:
          "Uses environmental and animal surveillance to predict where Buruli ulcer will emerge before human cases appear.",
        limitation:
...

  {
    ...
    records: [
      ...
      },
      {
        ...
        diseases: ["dengue-chikungunya", "snakebite"],
