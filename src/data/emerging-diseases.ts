...
export const emergingDiseases: RecordOf<"diseases">[] = [
...

  {
    ...
    stats: [
      { label: "Cases (2024)", value: "282 million", number: 282, unit: "million cases", year: 2024, geography: "80 countries", note: "up about 9 million (3%) on 2023", source: { label: "WHO — malaria (fact sheet)", url: "https://www.who.int/news-room/fact-sheets/detail/malaria" } },
      { label: "Deaths (2024)", value: "610,000", number: 610000, unit: "deaths", year: 2024, geography: "global", note: "up from 598,000 in 2023", source: { label: "WHO — malaria (fact sheet)", url: "https://www.who.int/news-room/fact-sheets/detail/malaria" } },
      { label: "African Region share", value: "95%", number: 95, unit: "%", year: 2024, geography: "WHO African Region", note: "265 million cases and 579,000 deaths", source: { label: "WHO — malaria (fact sheet)", url: "https://www.who.int/news-room/fact-sheets/detail/malaria" } },
      { label: "Children under 5", value: "~75%", unit: "%", geography: "WHO African Region", note: "of all malaria deaths in the Region", source: { label: "WHO — malaria (fact sheet)", url: "https://www.who.int/news-room/fact-sheets/detail/malaria" } },
      { label: "Vaccines recommended", value: "2", number: 2, unit: "vaccines", note: "RTS,S/AS01 (2021) and R21/Matrix-M (2023)", source: { label: "WHO — malaria (fact sheet)", url: "https://www.who.int/news-room/fact-sheets/detail/malaria" } },
    ],
    timeline: [
    ...
    stats: [
      {
        ...
        geography: "global",
        note: "WHO estimate",
        source: { label: "WHO — Global tuberculosis report 2024", url: "https://www.who.int/teams/global-programme-on-tuberculosis-and-lung-health/tb-reports/global-tuberculosis-report-2024" },
      },
      {
        label: "Deaths",
        value: "1.25 million",
        ...
        year: 2023,
        geography: "global",
        note: "including 161,000 among people with HIV",
        source: { label: "WHO — Global tuberculosis report 2024", url: "https://www.who.int/teams/global-programme-on-tuberculosis-and-lung-health/tb-reports/global-tuberculosis-report-2024" },
      },
      {
        label: "Drug-resistant cases",
        value: "400,000",
        number: 400000,
        unit: "cases",
        year: 2023,
        geography: "global",
        note: "multidrug-resistant or rifampicin-resistant, per year",
        source: { label: "WHO — Global tuberculosis report 2024", url: "https://www.who.int/teams/global-programme-on-tuberculosis-and-lung-health/tb-reports/global-tuberculosis-report-2024" },
      },
...

  {
    ...
    stats: [
      ...
      { label: "West Africa, 2014–16", value: "> 11,000 deaths", number: 11000, unit: "deaths", year: 2016, note: "the largest outbreak on record", source: { label: "WHO — Ebola disease (fact sheet)", url: "https://www.who.int/news-room/fact-sheets/detail/ebola-disease" } },
      { label: "DRC, 2018–20", value: "2,287 deaths", number: 2287, unit: "deaths", year: 2020, note: "the second-largest outbreak", source: { label: "WHO — Ebola disease (fact sheet)", url: "https://www.who.int/news-room/fact-sheets/detail/ebola-disease" } },
      { label: "Licensed vaccines", value: "2", number: 2, unit: "vaccines", note: "ERVEBO (2019) and Zabdeno/Mvabea (2020)", source: { label: "WHO — Ebola disease (fact sheet)", url: "https://www.who.int/news-room/fact-sheets/detail/ebola-disease" } },
