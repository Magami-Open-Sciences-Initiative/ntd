...
export const trials: RecordOf<"trials">[] = [
  ...
  },
  {
    ...
    asOf: "2026-09",
    phase: "Phase 2",
    registry: "ClinicalTrials.gov NCT05957978",
    status: "Reported — Phase 2 proof-of-concept completed",
    intervention: "DNDi-0690, oral",
    result: "The Phase 2 proof-of-concept study in Ethiopia completed; DNDi is advancing the compound (also known as LXE408) into further Phase 2 studies.",
    links: [
